...
export default function ServicesSection({ onSelectPackage }: ServicesSectionProps) {
  ...
  const packages = [
    ...
    },
    {
      ...
      bgColor: "bg-rose-50/50 border border-rose-200 ring-2 ring-rose-500/20",
    ...
    },
    {
      ...
      bgColor: "bg-emerald-50/50 border border-emerald-200 ring-2 ring-emerald-500/10",
    ...
    },
    {
      ...
      bgColor: "bg-amber-50/50 border border-amber-200 ring-2 ring-amber-500/10",
    ...
    },
    {
      ...
      bgColor: "bg-blue-50/50 border border-blue-200 ring-2 ring-blue-500/10",
